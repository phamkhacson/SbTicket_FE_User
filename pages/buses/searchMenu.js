...
const SearchMenu = ({ buses, info }) => {
  ...
  const [formData, setFormData] = useState({
    startLocation: info.firstPoint,
    endLocation: info.lastPoint,
    journeyDate: info.dateTime
  });
  ...
  return (
    <div className="route-form bus-search-menu m-1">
      ...
      <DatePicker
        ...
        defaultValue={moment(info.dateTime, "YYYY-MM-DD")}
